<?php
// Dummy content untuk form tambah siswa - akan dibuat lengkap
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputEmail3" name="siswa">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <input type="date" class="form-control" id="inputEmail3" name="tanggal_lahir">
                        </div>
                    </div>
                    <div class="row mb-3">
